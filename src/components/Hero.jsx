        ...
        <div className="flex flex-col items-start gap-8">
          ...
          <div className="flex flex-wrap gap-4 animate-entrance delay-200">
            ...
            <button 
              ...
              className="bg-transparent border border-border-subtle hover:border-primary/50 text-white px-8 py-3 rounded-full font-body-md text-body-md flex items-center gap-2 transition-all duration-300 hover:bg-white/5 hover:scale-95 glass-card">
